    ...
    <div className="w-full min-h-[100dvh]">
      ...
      <section className="px-6 py-16 sm:py-20 lg:py-28 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-[14px] lg:text-[16px] text-[#6B6966] mb-12 lg:mb-16">수유 · 수면 · 성장 · 이유식 — 기본은 확실하게</p>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            {[
              { video: '/images/illustrations/t3.webm', title: '수유·수면 기록', desc: 'FAB 한 번으로 바로 기록' },
              { video: '/images/illustrations/h3.webm', title: '성장 차트', desc: '표준 백분위 비교' },
              { video: '/images/illustrations/e2.webm', title: '발달 마일스톤', desc: '월령별 첫 순간 체크' },
              { video: '/images/illustrations/f4.webm', title: '이유식 가이드', desc: '단계별 식재료·알레르기' },
            ].map(f => (
      ...
      <section className="px-6 py-16 sm:py-20 lg:py-28" style={{ background: 'linear-gradient(180deg, #FFF8F3 0%, #FFF0E8 100%)' }}>
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-[14px] lg:text-[16px] text-[#6B6966] mb-12 lg:mb-16">뭘 해야 할지 고민할 필요 없어요. 도담이 먼저 챙겨줄게요.</p>

          <div className="space-y-4 lg:space-y-5">
            {[
              {
                video: '/images/illustrations/t3.webm',
                before: '"오늘 뭘 해야 하지?" 앱을 켜도 막막함',
                after: '아침마다 AI 브리핑으로 오늘의 수유·수면·예방접종 일정을 먼저 알려줘요',
              },
              {
                video: '/images/illustrations/t3.webm',
                before: '"다음 수유 언제지?" 매번 시간 계산',
                after: 'AI가 패턴을 분석해서 다음 수유·수면 타이밍을 미리 알려줘요',
              },
              {
                video: '/images/illustrations/f2.webm',
                before: '"오늘 뭐 해먹이지?" 매일 검색',
                after: '월령·알레르기·어제 먹은 것까지 고려해 오늘 이유식을 제안해요',
              },
              {
                video: '/images/illustrations/e1.webm',
                before: '"갑자기 열이 나는데..." 새벽에 물어볼 곳 없음',
                after: '24시간 AI 육아 SOS — 증상 체크리스트와 대응법을 바로 알려줘요',
              },
              {
                video: '/images/illustrations/h3.webm',
                before: '"잘 크고 있는 건지..." 수치만 보고 불안',
                after: '검진표를 찍으면 AI가 해석해주고, 성장 급등기·둔화기를 알려줘요',
              },
            ].map(item => (
      ...
      <section className="px-6 py-16 sm:py-20 lg:py-28 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-[14px] lg:text-[16px] text-[#6B6966] mb-12 lg:mb-16">단계마다 딱 필요한 것만, AI가 먼저 챙겨줘요</p>
          <div className="space-y-3 lg:space-y-4">
            {[
              { bg: 'from-[#FFE0EC] to-[#FFF0F5]', video: '/images/illustrations/onboarding-preparing.webm', label: '아기를 기다리고 있어요', desc: '배란일 · 가임기 알림 · 마음 체크 · AI 건강 코치' },
              { bg: 'from-[#FFE8D0] to-[#FFF8F0]', video: '/images/illustrations/onboarding-pregnant.webm', label: '배 속에 아기가 자라고 있어요', desc: '주차별 태아 성장 · 검진 일정 관리 · AI 맞춤 가이드' },
              { bg: 'from-[#D5F0E0] to-[#F0FAF4]', video: '/images/illustrations/onboarding-parenting.webm', label: '우리 아이를 키우고 있어요', desc: '수유·수면 기록 · AI 아침 브리핑 · 성장 리포트 · 육아 SOS' },
            ].map(m => (
      ...
      <section className="px-6 py-16 sm:py-20 lg:py-28 bg-[#FAFAFA]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-[14px] lg:text-[16px] text-[#6B6966] mb-12 lg:mb-16">육아의 크고 작은 순간들을 함께해요</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4">
            {[
              { video: '/images/illustrations/f2.webm', title: '"검진 결과가 무슨 뜻이야?"', desc: '검진결과표 사진 한 장, AI가 쉽게 풀어줘요' },
              { video: '/images/illustrations/t5.webm', title: '"이 이름, 괜찮을까?"', desc: 'AI 추천 · 음양오행 · 한자 획수 분석' },
              { video: '/images/illustrations/t4.webm', title: '"받을 수 있는 지원금이 있대"', desc: '부모급여·아동수당·보육료 혜택 한눈에' },
              { video: '/images/illustrations/e1.webm', title: '"예방접종 언제 맞혀야 하지?"', desc: '스케줄 알림 · 완료 체크 · 부작용 안내' },
            ].map(h => (
