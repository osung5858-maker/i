...
export const COLOR_THEMES: ColorTheme[] = [
  ...
  },
  {
    ...
    pageBg: '#FDF8EE',
    cardShadow: 'rgba(139,113,58,0.08)',
    headerShadow: 'rgba(139,113,58,0.1)',
    tabShadow: 'rgba(139,113,58,0.06)',
    fabGradientFrom: '#D4B470',
    fabGradientTo: '#8B713A',
    fabShadow: 'rgba(139,113,58,0.35)',
  },
  {
    id: 'sage',
    name: '세이지 민트',
